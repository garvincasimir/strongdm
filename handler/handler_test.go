...
func TestHandleRequest_MultipleClients(t *testing.T) {
	...
	h.HandleRequest(w1, client1)

	w2 := httptest.NewRecorder()
	h.HandleRequest(w2, client2)
	...
	var info1, info2 counter.Info
	_ = json.Unmarshal(w1.Body.Bytes(), &info1)
	_ = json.Unmarshal(w2.Body.Bytes(), &info2)
